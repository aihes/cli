...
读取规则：先使用本文件完成大类判断；只要用户意图明确命中下方二类，就必须额外读取并严格执行一个具体体裁文件。只有未命中任何二类时，才把本文件作为最终体裁。不要读取多个报告体裁文件。
...
| 用户意图 / 信号词 | 读取文件 |
|---|---|
| 行业报告、调研报告、用户研究、市场研究、研究报告 | [`research-report.md`](research-report.md) |
| 数据报告、指标分析、经营数据、漏斗分析、仪表盘解读 | [`data-report.md`](data-report.md) |
| 白皮书、趋势报告、方法论报告、权威长报告 | [`white-paper.md`](white-paper.md) |
| 商业分析、战略分析、竞品分析、商业计划分析 | [`business-analysis.md`](business-analysis.md) |
