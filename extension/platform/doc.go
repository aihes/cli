...
//
// Stability: every exported symbol here is part of the contract. Exported
// structs (Rule, Capabilities, SkillsOverlay) may gain new fields across
// minor versions -- construct them with keyed literals, per standard Go
// module-compatibility practice. Interfaces never gain methods; new host
// capability surfaces arrive as optional extension interfaces (see
// EmbeddedSkillsRegistrar). Internal
